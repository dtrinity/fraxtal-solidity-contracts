...
async function main(): Promise<void> {
  ...
  const lowerBoundTargetLeverageBps = await dLOOPUniswapV3Contract.LOWER_BOUND_TARGET_LEVERAGE_BPS();
  const upperBoundTargetLeverageBps = await dLOOPUniswapV3Contract.UPPER_BOUND_TARGET_LEVERAGE_BPS();
