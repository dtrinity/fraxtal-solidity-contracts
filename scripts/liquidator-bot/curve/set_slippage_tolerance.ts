...
import { getFlashLoanLiquidatorBot } from "../../../utils/liquidator-bot/curve/utils";

/**
 * Set the slippage tolerance for the Curve liquidator bot
 *
 * To run this script, run the following command:
 *    yarn hardhat run --network <network> scripts/liquidator-bot/curve/set_slippage_tolerance.ts
 */
