...
for i in "${!networks[@]}"; do
    ...
    api3_addresses=($(collect_addresses "$network_dir" "API3" "Curve")) # Exclude CurveAPI3 feeds from API3 fees because they are actually Curve feeds
    ...
    curve_api3_addresses=($(collect_addresses "$network_dir" "CurveAPI3")) # Avoid matching on non-oracle Curve contracts
