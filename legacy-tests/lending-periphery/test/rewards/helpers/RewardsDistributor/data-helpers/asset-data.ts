...
/**
 *
 * @param assetConfigUpdateInput
 * @param assetConfigBefore
 * @param assetConfigAfter
 * @param actionBlockTimestamp
 * @param compareRules
 */
export function rewardsDataComparator<
  Input extends AssetUpdateDataV2,
  State extends RewardData,
>(
    ...
    actionBlockTimestamp,
    {
      ...
      fieldsWithCustomLogic: [
        // should happen on any update
        {
          ...
          logic: (stateUpdate, stateBefore, stateAfter, txTimestamp) =>
