...
library OdosSwapLogic {
    ...
    function swapExactOutput(
        ...
        OdosSwapUtils.excuteSwapOperation(odosRouter, address(inputToken), amountInMaximum, amountOut, swapData);
        ...
        if (inputTokenBalanceAfter < inputTokenBalanceBefore) {
            amountIn = inputTokenBalanceBefore - inputTokenBalanceAfter;
        }
    }
}
