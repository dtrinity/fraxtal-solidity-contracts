 ...
 * @notice DSwap Adapter to perform a repay of a debt with collateral.
 **/
contract DSwapRepayAdapter is BaseDSwapBuyAdapter, ReentrancyGuard {
    ...
    constructor(
        ...
        address owner
    ) BaseDSwapBuyAdapter(addressesProvider, swapRouter) {
     ...
     *   uint24 swapPoolFee DSwap pool fee
