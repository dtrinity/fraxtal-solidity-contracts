...
import "../dex/core/interfaces/IUniswapV3Pool.sol";
import "../dex/periphery/libraries/PoolAddress.sol";
import "../dex/periphery/libraries/OracleLibrary.sol";
...
contract StaticOracle is IStaticOracle {
    ...
    function quoteAllAvailablePoolsWithTimePeriod(
        ...
        return quoteAllAvailablePoolsWithOffsetTimePeriod(_baseAmount, _baseToken, _quoteToken, _period, 0);
    }
    ...
    function quoteSpecificFeeTiersWithTimePeriod(
        ...
        return quoteSpecificFeeTiersWithOffsetTimePeriod(_baseAmount, _baseToken, _quoteToken, _feeTiers, _period, 0);
    }
    ...
    function prepareSpecificFeeTiersWithTimePeriod(
        ...
        return
            prepareSpecificFeeTiersWithCardinality(_tokenA, _tokenB, _feeTiers, _getCardinalityForTimePeriod(_period));
    }
    ...
    function _quote(
        ...
        for (uint256 i; i < _pools.length; i++) {
            (_tickData[i].tick, _tickData[i].weight) = _period > 0
                ? OracleLibraryPlus.consultOffset(_pools[i], _period, _offset)
