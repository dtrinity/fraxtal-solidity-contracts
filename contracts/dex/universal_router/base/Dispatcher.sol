...
abstract contract Dispatcher is NFTImmutables, Payments, V3SwapRouter, Callbacks, LockAndMsgSender {
    ...
    function dispatch(bytes1 commandType, bytes calldata inputs) internal returns (bool success, bytes memory output) {
        ...
        require(command != Commands.V2_SWAP_EXACT_OUT, "Not supported V2 swap exact out");
        require(command != Commands.V2_SWAP_EXACT_IN, "Not supported V2 swap exact in");
