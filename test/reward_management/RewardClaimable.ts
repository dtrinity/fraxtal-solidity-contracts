...
describe("RewardClaimable", function () {
  ...
  beforeEach(async function () {
    ...
    exchangeAsset = (await MockERC20Factory.deploy(
      "Exchange Asset",
      "EA",
  ...
  describe("claimRewards", function () {
    ...
    const runClaimRewardsTestCase = async (
      testCase: ClaimRewardsTestCase,
    ): Promise<void> => {
  ...
  describe("compoundRewards", function () {
    it("Compound with 10% treasury fee", async function () {
      ...
      console.log(
        `Expected treasury fee 1: ${expectedTreasuryFee1}, Actual: ${actualTreasuryFee1}`,
      );
      console.log(
        `Expected treasury fee 2: ${expectedTreasuryFee2}, Actual: ${actualTreasuryFee2}`,
      );
      ...
      console.log(
        `Expected user reward 1: ${expectedUserReward1}, Actual: ${actualUserReward1}`,
      );
      console.log(
        `Expected user reward 2: ${expectedUserReward2}, Actual: ${actualUserReward2}`,
      );
