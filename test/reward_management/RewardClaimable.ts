...
import { ONE_HUNDRED_PERCENT_BPS, ONE_PERCENT_BPS } from "../../utils/constants";
...
describe("RewardClaimable", function () {
  ...
  beforeEach(async function () {
    ...
    exchangeAsset = (await MockERC20Factory.deploy("Exchange Asset", "EA")) as unknown as MockERC20;
    rewardToken1 = (await MockERC20Factory.deploy("Reward Token 1", "RT1")) as unknown as MockERC20;
    rewardToken2 = (await MockERC20Factory.deploy("Reward Token 2", "RT2")) as unknown as MockERC20;
  ...
  describe("claimRewards", function () {
    ...
    const runClaimRewardsTestCase = async (testCase: ClaimRewardsTestCase): Promise<void> => {
