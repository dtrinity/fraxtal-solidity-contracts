...
export const standardDLoopUniswapV3WithMockOracleFixture = deployments.createFixture(async ({ deployments }) => {
  await standardUniswapV3DEXLBPLiquidityWithMockOracleFixtureImplementation(deployments, ["dloop"]);
...
export const standardDLoopUniswapV3Fixture = deployments.createFixture(async ({ deployments }) => {
  await standardUniswapV3DEXLBPLiquidityFixtureImplementation(deployments, ["dloop"]);
...
export const standardDLoopCurveWithMockOracleFixture = deployments.createFixture(async ({ deployments }) => {
  await standardCurveDEXLBPLiquidityWithMockOracleFixtureImplementation(deployments, ["dloop"]);
...
export const standardDLoopCurveFixture = deployments.createFixture(async ({ deployments }) => {
  await standardCurveDEXLBPLiquidityFixtureImplementation(deployments, ["dloop"]);
...
export const standardDLoopMockCurveWithMockOracleFixture = deployments.createFixture(async ({ deployments }) => {
  await standardMockCurveDEXLBPLiquidityWithMockOracleFixtureImplementation(deployments, ["dloop"]);
});
