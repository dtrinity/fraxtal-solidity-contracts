...
import { AMO_MANAGER_ID, COLLATERAL_VAULT_CONTRACT_ID, ISSUER_CONTRACT_ID } from "../../utils/deploy-ids";
...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  await deployContract(
    hre,
    ISSUER_CONTRACT_ID,
    [collateralVaultAddress, dusd.address, oracleAggregatorAddress, amoManagerAddress],
    undefined, // auto-filled gas limit
    await hre.ethers.getSigner(dusdDeployer),
    undefined, // no libraries
    "Issuer", // actual contract name
  );
