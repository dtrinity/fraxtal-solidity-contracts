...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  if (isLocalNetwork(hre.network.name)) {
    ...
    return deployFlashLoanLiquidatorBot(
      ...
      poolAddress,
      50 * 100 * ONE_BPS_UNIT, // 50% slippage tolerance
      mockCurveSwapRouterAddress,
      20 * 100 * ONE_BPS_UNIT, // 20% slippage surplus swap
      [],
      {}, // No default proxy contracts
    );
  }
