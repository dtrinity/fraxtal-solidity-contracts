...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  if (Object.keys(reservesAddresses).length === 0 || !reservesAddresses[RESERVE_SYMBOL]) {
    console.warn(`[WARNING] Skipping initialization. Empty asset list or missing ${RESERVE_SYMBOL} reserve.`);
    return true;
  }
