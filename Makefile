...
ROLES_NETWORK ?= fraxtal_mainnet
ROLES_MANIFEST ?= manifests/fraxtal-mainnet-roles.json
...
.PHONY: install install.ci clean lint.typescript.ci lint.typescript lint.contract lint.contract.ci lint lint.ci git.unstaged-check.ci compile compute.dex.pool-init-code test test.lbp.legacy test.hardhat test.hardhat.dusd test.curve test.unit run.node.localhost run.node.local_ethereum sync-laika deploy deploy-mint.tokens mint.tokens deploy-price-aggregators deploy-and-point-price-aggregators unset-price-aggregators deploy-test-weth9 deploy-liquidator-bot deploy-liquidator-bot.reset deploy-liquidator-bot.fraxtal_testnet deploy-liquidator-bot.fraxtal_mainnet deploy-contract deploy-contract.reset deploy-contract.localhost deploy-contract.localhost.reset deploy-contract.fraxtal_testnet deploy-contract.fraxtal_testnet.reset deploy-contract.dloop deploy-contract.dloop.fraxtal_testnet deploy-contract.dloop.fraxtal_mainnet deploy-contract.dloop.fraxtal_testnet.reset deploy-contract.dloop.fraxtal_mainnet.reset deploy-dloop deploy-dloop.reset deploy-dloop.fraxtal_testnet deploy-dloop.fraxtal_mainnet deploy-dloop.fraxtal_testnet.reset deploy-dloop.fraxtal_mainnet.reset deploy-contract.liquidator-bot deploy-contract.liquidator-bot.fraxtal_mainnet deploy-contract.liquidator-bot.fraxtal_testnet deploy-contract.local_ethereum deploy-contract.local_ethereum.reset deploy-dusd deploy-dusd.reset deploy-dusd.localhost deploy-dusd.localhost.reset deploy-dusd.fraxtal_testnet deploy-dusd.fraxtal_testnet.reset deploy-dusd-amo-vault deploy-dusd-amo-vault.reset deploy-dusd-amo-vault.local deploy-dusd-amo-vault.local.reset deploy-dusd-amo-vault.fraxtal_testnet deploy-dusd-amo-vault.fraxtal_testnet.reset init-pool.dex.% init-pool.dex.fraxtal_testnet add-pool-liquidity.dex.% add-pool-liquidity.dex.fraxtal_testnet swap.dex.% swap.dex.fraxtal_testnet check-pool-state.dex.% check-pool-state.dex.fraxtal_testnet lending.get-emission-admin.% lending.get-emission-admin.fraxtal_testnet lending.get-emission-admin.localhost lending.set-emission-admin.% lending.set-emission-admin.fraxtal_testnet lending.set-emission-admin.localhost lending.get-rewards-data.% lending.get-rewards-data.fraxtal_testnet lending.get-rewards-data.localhost lending.configure-incentives.% lending.configure-incentives.fraxtal_testnet lending.configure-incentives.localhost lending.deposit-reward.% lending.deposit-reward.fraxtal_testnet lending.deposit-reward.localhost lending.set-reserve-config.% lending.set-reserve-config.fraxtal_testnet lending.set-reserve-config.localhost oracle.set-asset-sources.% oracle.set-asset-sources.fraxtal_testnet oracle.set-asset-sources.localhost oracle.set-mock-price.% oracle.set-mock-price.fraxtal_testnet oracle.set-mock-price.localhost run.liquidator-bot.% run.liquidator-bot.fraxtal_testnet run.liquidator-bot.localhost run.liquidator-bot.fraxtal_mainnet docker.build.liquidator-bot docker.build.liquidator-bot.arm64 docker.build.liquidator-bot.amd64 docker.buildandrun.liquidator-bot.arm64 docker.buildandrun.liquidator-bot.slack-bot docker.buildandrun.liquidator-bot.slack-bot.amd64 docker.buildandrun.liquidator-bot.slack-bot.arm64 docker.dump-image.liquidator-bot docker.buildanddump-image.liquidator-bot docker.buildanddump-image.liquidator-bot.arm64 docker.buildanddump-image.liquidator-bot.amd64 docker.deploy.liquidator-bot docker.deploy.liquidator-bot.fraxtal_testnet docker.deploy.liquidator-bot.fraxtal_mainnet docker.deploy.liquidator-bot.slack-bot docker.buildanddeploy.liquidator-bot.fraxtal_testnet.curve docker.buildanddeploy.liquidator-bot.fraxtal_mainnet docker.buildanddeploy.liquidator-bot.fraxtal_mainnet.curve docker.buildanddeploy.liquidator-bot.fraxtal_mainnet.odos docker.buildanddeploy.liquidator-bot.fraxtal_mainnet.combo docker.buildanddeploy.liquidator-bot.slack-bot docker.buildanddeploy.liquidator-bot.slack-bot.fraxtal_mainnet remote.ssh.liquidator-bot remote.upload remote.push-image.liquidator-bot remote.download.liquidator-bot-state remote.download.liquidator-bot-state.fraxtal_testnet curve-tools.generate-swap-params explorer.verify.fraxtal_testnet explorer.verify.fraxtal_mainnet check-all-users-health-factor check-all-users-health-factor.fraxtal_testnet check-all-users-health-factor.fraxtal_mainnet zip-directory copy-to-public create-public-docker-image.liquidator-bot.arm64 create-public-docker-image.liquidator-bot.amd64 create-public-docker-image.liquidator-bot.all
...
test: test.hardhat # A convenient shorthand to align with other repo Makefile targets
...
deploy-dloop:
	...
	@echo "Deploying DLoop contracts to $(network) network..."
	@DEPLOY_DLOOP=true yarn hardhat deploy $(flag) --network $(network) --tags "dloop" \
		2>&1 | tee ./deployments-log/$(network)-deploy_dloop.log

deploy-dloop.reset: flag="--reset"
deploy-dloop.reset: deploy-dloop

deploy-dloop.fraxtal_testnet: network=fraxtal_testnet
deploy-dloop.fraxtal_testnet: deploy-dloop

deploy-dloop.fraxtal_mainnet: network=fraxtal_mainnet
deploy-dloop.fraxtal_mainnet: deploy-dloop

deploy-dloop.fraxtal_testnet.reset: network=fraxtal_testnet
deploy-dloop.fraxtal_testnet.reset: deploy-dloop.reset

deploy-dloop.fraxtal_mainnet.reset: network=fraxtal_mainnet
deploy-dloop.fraxtal_mainnet.reset: deploy-dloop.reset
